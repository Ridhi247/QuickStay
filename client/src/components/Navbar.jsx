...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      setIsScrolled(window.scrollY > 10); // Correct scroll detection
    };
  ...
  return (
    <>
      ...
      {/* Scrollable Dummy Content */}
      {/* <div className="mt-24 h-[2000px] bg-gray-100"> */}
        {/* Replace this with actual page content */}
      {/* </div> */}
    </>
  );
};
